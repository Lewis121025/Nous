...
export default defineConfig({
  test: {
    include: [
      ...
      "../../tests/reader/e2e/dead-link-create.test.mts",
      "../../tests/reader/e2e/mention-linkify.test.mts",
      "../../tests/reader/e2e/embeds.test.mts",
      "../../tests/reader/e2e/properties.test.mts",
