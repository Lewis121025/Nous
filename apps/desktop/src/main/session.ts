...
export function parseSession(raw: string): Session | null {
  ...
  return {
    ...
    filesCollapsed: "filesCollapsed" in data && data.filesCollapsed === true,
    outlineCollapsed: "outlineCollapsed" in data && data.outlineCollapsed === true,
  };
}
